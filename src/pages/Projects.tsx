  ...
  return (
    <section id="projects" className="py-12 sm:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-slate-900 p-6 sm:p-10 lg:p-12 rounded-xl text-white">
          <h3 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center">Premium Steel Brands We Use</h3>
